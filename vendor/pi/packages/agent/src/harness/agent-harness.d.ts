...
import type { BranchSummaryEntry, CompactionEntry, Entry, JsonValue, ProvisionedEntry, Session, SessionTree } from "./session/index.js";
import type { TelemetryContext } from "./telemetry.js";
import type { AgentHarnessResources, PromptTemplate, Skill } from "./types.js";
declare const LaneBusy_base: import("./result.js").TaggedErrorFactory<"LaneBusy">;
...
declare const MissingIdentities_base: import("./result.js").TaggedErrorFactory<"MissingIdentities">;
...
declare const NoActiveRun_base: import("./result.js").TaggedErrorFactory<"NoActiveRun">;
export declare class NoActiveRun extends NoActiveRun_base<{
    lane: string;
    message: string;
}> {
}
declare const NoActiveOperation_base: import("./result.js").TaggedErrorFactory<"NoActiveOperation">;
export declare class NoActiveOperation extends NoActiveOperation_base<{
    lane: string;
    message: string;
}> {
}
declare const NothingToResume_base: import("./result.js").TaggedErrorFactory<"NothingToResume">;
export declare class NothingToResume extends NothingToResume_base<{
    lane: string;
    message: string;
}> {
}
declare const InvalidMessage_base: import("./result.js").TaggedErrorFactory<"InvalidMessage">;
...
declare const UnknownSkill_base: import("./result.js").TaggedErrorFactory<"UnknownSkill">;
export declare class UnknownSkill extends UnknownSkill_base<{
    name: string;
    message: string;
}> {
}
declare const UnknownTemplate_base: import("./result.js").TaggedErrorFactory<"UnknownTemplate">;
export declare class UnknownTemplate extends UnknownTemplate_base<{
    name: string;
    message: string;
}> {
}
declare const UnknownTarget_base: import("./result.js").TaggedErrorFactory<"UnknownTarget">;
export declare class UnknownTarget extends UnknownTarget_base<{
    targetId: string;
    message: string;
}> {
}
declare const UnknownQueueItem_base: import("./result.js").TaggedErrorFactory<"UnknownQueueItem">;
...
declare const LaneExists_base: import("./result.js").TaggedErrorFactory<"LaneExists">;
export declare class LaneExists extends LaneExists_base<{
    lane: string;
    message: string;
}> {
}
declare const InvalidLane_base: import("./result.js").TaggedErrorFactory<"InvalidLane">;
...
declare const NothingToCompact_base: import("./result.js").TaggedErrorFactory<"NothingToCompact">;
export declare class NothingToCompact extends NothingToCompact_base<{
    lane: string;
    message: string;
}> {
}
declare const Closed_base: import("./result.js").TaggedErrorFactory<"Closed">;
