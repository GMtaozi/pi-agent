...
import type { AssistantMessage, AssistantMessageEventStream, Context, DeferredCancelOptions, DeferredFetchOptions, DeferredHandle, Model, SimpleStreamOptions, StreamFunction, TextContent, ThinkingContent, ToolCall } from "../types.js";
...
export declare function createFauxCore(options: RegisterFauxProviderOptions): {
    ...
    fetchDeferred: (requestModel: Model<string>, handle: DeferredHandle, fetchOptions?: DeferredFetchOptions) => AssistantMessageEventStream;
    cancelDeferred: (requestModel: Model<string>, handle: DeferredHandle, cancelOptions?: DeferredCancelOptions) => Promise<void>;
    getModel: {
        (): Model<string>;
