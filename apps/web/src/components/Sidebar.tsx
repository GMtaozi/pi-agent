...
import { Folder, Settings, ChevronRight, MessageSquare, Activity, ArrowUp, Monitor, FileText, Coins, Database, Sparkles, Puzzle, Plug } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="sidebar-footer">
        ...
        <button className="settings-trigger" onClick={() => navigate('/plugins')}>
          <Puzzle size={18} />
          {!collapsed && <span>插件市场</span>}
        </button>
        <button className="settings-trigger" onClick={() => navigate('/mcp-config')}>
          <Plug size={18} />
          {!collapsed && <span>MCP 配置</span>}
        </button>
      </div>
